...
(function () {
  ...
  if (window.__nroUserscriptStarted) {
    return;
  }
  window.__nroUserscriptStarted = true;

  function getValue(key) {
    try {
      return Promise.resolve(GM_getValue(key, null));
    } catch (error) {
      return Promise.resolve(null);
    }
  }
  ...
  var app = window.NetflixRatingsCore.createApp({
    ...
    registerMenuCommand: function (label, handler) {
